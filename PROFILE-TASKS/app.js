$(document).ready(function(){
    ...
    $.ajax({
        url: 'PROFILE-TASKS/task-perfil.php',
        type: 'GET',
...
//MOSTRAR CONTAINER DE PERFIL USUARIO
    $.ajax({
        url: 'PROFILE-TASKS/task-show-pict.php',
        type: 'GET',
        success: function (response) {
            let tasks = JSON.parse(response);
            let include = `
    ...
    $(document).on('click', '#editdates', function(e){
        ...
        $.ajax({
            url: 'PROFILE-TASKS/task-info-user.php',
            type: 'GET',
            success: function(response) {
                let tasks = JSON.parse(response);
                let include = `
    ...
    $(document).on('click', '#btnUpdateDates', function (e) {
        ...
        $('.between').remove();
        $.ajax({
            url: 'PROFILE-TASKS/task-update-user.php',
            type: 'POST',
            data: {nombre: name,
                apellido: lastname,
    ...
    $(document).on('click', '#enviaCV', function(eve) {
        ...
        console.log("fhola");
        $.ajax({
            url: 'PROFILE-TASKS/task-archivo.php',
            type: 'POST',
            data: archivo,
            contentType: false,
            processData: false,
    ...
    $(document).on('click', '#btnPerfil', function(){
        ...
        $.ajax({
            url: 'PROFILE-TASKS/task-picture.php',
            type: 'POST',
            data: archivo,
            contentType: false,
            processData: false,
