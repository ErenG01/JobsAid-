$(document).ready(function(){
  ...
  $("#Navegator").css({
    ...
    $.ajax({
        url: '../modelo/TASKS/task-list.php',
        type: 'GET',
    ...
    $(document).on('click', '#BtnSearchOferts', function(e){
      ...
      $.ajax({
        url: '../modelo/TASKS/task-searchOfert.php',
        type: 'POST',
        data: { cargo: puesto,
                city: ciudad,
                },
    ...
    $(document).on('click', '#Avancant', function(e){
      $('#asidecontainervacantes').remove();
        ...
        console.log(idv);
        $.post('../modelo/TASKS/task-show.php', {idv}, function(response) {
    ...
    $(document).on('click', '#btnFiltroVer', function (eve) {
      ...
      $.ajax({
        url: '../modelo/TASKS/task-filtro.php',
        type: 'POST',
        data: { city: cuidad,
  ...
  $(document).on('click', '#postularse', function(){
    ...
    var resultado = window.confirm('Estas seguro?');
      if (resultado === true) {
        let element = $(this)[0].parentElement;
        let idv = $(element).attr('vacantid');
        $.post('../modelo/TASKS/task-add.php', {idv}, function(response) {
